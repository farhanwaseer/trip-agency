...
export const DESTINATIONS: Destination[] = [
  {
    ...
    description: 'A land of emerald terraces, towering peaks, and legends of eternal youth. Framed by Passu Cones and Rakaposhi, Hunza offers the ultimate blend of high-altitude adventure, deep local hospitality, and striking turquoise waters.',
  ...
  },
  {
    ...
    description: 'An alpine meadow tucked high beneath the chilling, monumental north face of Nanga Parbat (the Killer Mountain, 8,126m). Reachable via a thrilling jeep ride and pine-scented hike, it offers unmatched tranquility and wood-cabin vibes.',
  ...
  },
  {
    ...
    description: 'The world\'s second-highest alpine plateau. A massive, windswept wilderness carpeted in wildflowers during summer, inhabited by the rare Himalayan Brown Bear, and sitting directly beneath a dome of infinite stars.',
  ...
  },
  {
    ...
    description: 'The capital of high-altitude mountaineering. Surrounded by barren gray giants, cold desert sand dunes, and tranquil lakes, Skardu is the starting point for some of the world\'s most grueling mountain expeditions.',
  ...
  },
  {
    ...
    description: 'A lush green valley carved by the raging Kunhar River. Best known for the legendary Lake Saif-ul-Muluk, where fairies are said to descend, Naran is an active outdoor playground for white-water rafting and alpine hikes.',
  ...
  },
  {
    ...
    description: 'A stunning valley of roaring blue rivers, thick pine forests, and rich historical heritage. Home to the Malam Jabba ski resort, pristine alpine lakes like Mahodand, and deep archaeological ties to the Gandhara civilization.',
    ...
    highlights: ['Malam Jabba Ski Resort & Ziplining', 'Kalam Valley & Ushu Pine Forest', 'Mahodand Glacier Lake expedition', 'Swat River trout fishing & camping'],
  ...
  },
  {
    ...
    description: 'A beautiful mountain plateau sitting high above the Kaghan Valley. Accessible via a steep, winding road, Shogran is enveloped in dense pine forests and offers a base to hike into the ethereal Siri Paye cloud meadows.',
    ...
    highlights: ['Siri Paye Meadows horse ride', 'Hiking up to Siri Ridge', 'Sunset over the Pine Forest', 'Over-the-clouds photography sessions'],
  ...
  },
  {
    ...
    description: 'The highest paved international border crossing in the world at 4,693m, linking Pakistan with China. Flanked by deep winter snows and Karakoram National Park, it is a testament to engineering and extreme altitude.',
    ...
    highlights: ['Pakistan-China Friendship Arch', 'World\'s Highest ATM transaction', 'Karakoram National Park Yak spotting', 'Surreal altitude snowfields and glaciers'],
    ...
    itinerary: [
      {
        ...
        description: 'Meet at 4:00 AM at the Islamabad F-7 Hub. Board our private Coaster. Drive through the Hazara Motorway, climbing up Kaghan Valley. Cross Babusar Pass (4,173m) with breathtaking views of the Himalayas. Descend to Chilas along the Indus River. Welcome dinner and trip briefing.',
      ...
      },
      {
        ...
        description: 'Drive to Raikot Bridge on the KKH. Shift into open-air 4x4 Jeeps for a heart-pounding 1.5-hour ride on the edge of Raikot Gorge. Arrive at Tato Village. Strap on backpacks and embark on a 3-hour trek winding up pine forests. Catch first sights of Nanga Parbat glowing in evening light. Log cabin bonfire under the mountain star-dome.',
      ...
      },
      {
        ...
        description: 'Trek down to Tato Village. Take jeeps back down to Raikot Bridge. Join our private coach and head back to Islamabad. Stop for a celebratory trout-fish dinner in Swat/Naran bypass. Arrive back at F-7 Islamabad Hub by midnight.',
    ...
    itinerary: [
      {
        ...
        description: 'Depart Islamabad at 3:30 AM. Fly over K2 (weather permitting) or take the epic Jaglot-Skardu road carving through Karakoram gorges. Arrive in Skardu. Explore the pristine Shangrila Resort Lake and take a late-afternoon hike across the high Katpana Cold Desert sand dunes under a golden mountain sunset.',
      ...
      },
      {
        ...
        description: 'Board our rugged 4x4 land cruisers. Climb up the steep Skardu-Deosai gorge. Arrive at the breathtaking Sheosar High-Altitude Lake (4,114m). Set up our premium weather-proof expedition camps. Warm up with rich local soups. As darkness falls, witness the sheer clarity of the Milky Way galaxy stretching across the deep space sky. Astrophotography training session.',
      ...
      },
      {
        ...
        description: 'Pack up basecamp, leaving no trace behind. Descend into Shigar Valley. Visit the majestic, 400-year-old Shigar Fort, restored meticulously by AKTC. Relish a premium local Balti dinner of dried-fruit mutton inside the historical fort orchards. Warm, cozy beds to recover from high-altitude camping.',
      ...
      },
      {
        ...
        description: 'Board morning flight or drive back through the Karakoram Highway bypass. Reach Islamabad with high spirits, filled with starry memories and a heart connected to the ancient giants.',
    ...
    itinerary: [
      {
        ...
        description: 'Board the student caravan in Islamabad. Head out through Abbottabad and climb the spectacular mountain pass. Interactive games and ice-breaking inside the coaster. Cross Babusar Pass (4,173m) with full-scale music vibes. Arrive at Chilas riverside. Bonfire and traditional Pakhtun chicken Karahi.',
      ...
      },
      {
        ...
        description: 'Spend morning shopping at the local Karimabad gemstone bazaar (buy lapis lazuli and dry cherries). Engage in local discussions at Cafe de Hunza with delicious walnut cakes. Board coasters to descend back to Chilas. Midnight stargazing session by the rocky Indus.',
      ...
      },
      {
        ...
        description: 'Final long-drive back through Babusar Pass or Besham. Wrap up the journey with a heart-warming group session sharing stories and contact cards. Reach Islamabad Hub by 11:00 PM with life-long bonds formed.',
    ...
    itinerary: [
      {
        ...
        description: 'Depart Islamabad at 6:00 AM via Swat Motorway. Drive up the winding mountain pass surrounded by terraced citrus orchards. Arrive in Malam Jabba (2,804m). Get fitted for skis/snowboards. Professional ski instructors guide our first sliding lessons on the soft snow slopes. Sunset hot coffee at the slope-side cafe.',
      ...
      },
      {
        ...
        description: 'Board the scenic Malam Jabba Chairlift, gliding high above frosted pine tree-tops. Try the thrilling 1km dual zipline slicing through the mountain winds. After lunch, pack up and drive down Swat River to Kalam Valley. Explore Kalam bazaar, enjoy traditional local spinach (saag) and hot cornbread dinner.',
      ...
      },
      {
        ...
        description: 'Depart Kalam. Stop near Barikot to explore the ancient 2000-year-old Buddhist stupas and ruins of Gandhara. Learn about the peaceful historical roots of the valley. Head back on Swat Motorway, arriving at Islamabad Hub by 8:00 PM.',
    ...
    itinerary: [
      {
        ...
        description: 'Meet at 4:00 AM in Islamabad. Catch the scenic flight to Skardu or the classic highway run. Arrive in Skardu. Our mentors provide a pre-trip portfolio check. Capture the surreal blue-hour reflection of the Karakoram giants in Upper Kachura Lake. Dinner and framing seminar.',
      ...
      },
      {
        ...
        description: 'Wake up for a freezing-cold sunrise shoot on the sand dunes of Katpana Desert, framing the deep textures of cold sand against snowy high peaks. In the afternoon, travel to Shigar Valley. Visit an ancient wood-carved Mosque and set up standard portrait backdrops with local Balti elders, telling their stories through photography.',
      ...
      },
      {
        ...
        description: 'Capture the mist rising from the waters of Bara Pani at sunrise. Pack up dome camps and head back to Shigar Fort. Dedicate the afternoon to macro photography in the heritage gardens and editing/color-grading sessions in Lightroom. Showcase traveler photos in a micro-gallery exhibition.',
      ...
      },
      {
        ...
        description: 'Morning flight back to Islamabad or mountain drive. Gather at the F-7 Hub to print your best shots and share high-resolution social-media files.',
    ...
    itinerary: [
      {
        ...
        description: 'Fly from Islamabad to Gilgit on our premium charter or premium flights. Board private luxury 4x4 land cruisers to Karimabad, Hunza. Check into your ultra-luxury heated geodesic glamping domes overlooking the massive valley. Welcome organic grape-juice drink and premium briefing.',
      ...
      },
      {
        ...
        description: 'Start with a sunrise alpine yoga session on the glamping wooden decks. Embark on a private guided tour of Baltit Fort, with interactive scavenger team games based on local history. In the evening, drive to Eagle\'s Nest for a mindfulness breathing seminar directly facing Rakaposhi peak glowing at sunset.',
      ...
      },
      {
        ...
        description: 'Board luxury high-speed private speedboats at Attabad Lake. Cruise deep into the turquoise canyons. Return to a private, lakeside BBQ setup featuring live local sitar and rubab music, fire dances, and a gourmet 5-course organic Hunza meal including local mutton delicacies.',
      ...
      },
      {
        ...
        description: 'Walk the gentle, pristine track towards Passu Glacier snout, accompanied by certified alpine guides. Afternoon interactive sharing session with local Hunza educational and social development leaders, supporting community schools. Celebrate the trip with a final awards ceremony on the domes lawn.',
      ...
      },
      {
        ...
        description: 'Drive down to Gilgit Airport. Board flight back to Islamabad. Arrive at F-7 Departure Hub refreshed, aligned, and full of collaborative energy.',
...
export const TRAVELER_STORIES: TravelerStory[] = [
  {
    ...
    content: 'Standing on the Deosai plains at midnight with my camera was a spiritual experience. The Milky Way was so bright that it literally cast shadows on our yellow tents! Karakoram Expeditions handled the freezing 4,100m logistics flawlessly with hot soups and heated tents. I made friends for life.',
  ...
  },
  {
    ...
    content: 'We booked the luxury corporate retreat to Hunza. The heated geodesic domes are mind-blowing—you wake up looking directly at Passu Cones through a giant transparent window! The sitar night by Attabad lake was mystical. Our team has never been more aligned.',
  ...
  },
  {
    ...
    content: 'The jeep ride to Fairy Meadows was scary but exhilarating, and the trek up through pine forests felt like walking into Narnia. Nanga Parbat towers over you like a giant wall of ice. It was my first time visiting Pakistan, and the local hospitality left me speechless. 10/10 recommendation!',
    location: 'London, UK',
...
export const EXPEDITION_ALERTS: ExpeditionAlert[] = [
  {
    ...
    altitude: '4,114m',
    message: 'Team Astrophotography is currently pitching tents by Sheosar Lake. Sky is crystal clear, -2°C, galactic core is spectacular. All travelers in high spirits!',
  ...
  },
  {
    ...
    altitude: '3,300m',
    message: 'Team Odyssey has completed the trek to Beyal Camp. Nanga Parbat is pristine and visible. Bonfire is being lit. Local wood cabins are incredibly cozy.',
  ...
  },
  {
    ...
    altitude: '4,693m',
    message: 'Team Karakoram Caravan has successfully reached the China Border Arch. Freezing snow fields but hot local organic soup in Sost has energized everyone!',
...
export const PRE_DEPARTURE_CHECKLIST = [
  { category: 'Clothing', items: ['Waterproof windbreaker jacket', 'Thermal fleece layers (2 pair)', 'Dry-fit trekking shirts (4)', 'Hiking trousers with stretch', 'Warm wool beanie and gloves'] },
  { category: 'Footwear', items: ['Ankle-support broken-in hiking boots', 'Thick merino wool socks (3 pairs)', 'Lightweight camp slippers/sandals'] },
  { category: 'Gear', items: ['High-quality 10,000+ mAh power bank', 'Headlamp or strong torch with extra batteries', '1-Liter reusable insulated thermal water flask', 'Polarized UV-protection sunglasses', 'Compact trekking backpack (35L-45L)'] },
  { category: 'Hygiene & Meds', items: ['Broad-spectrum SPF 50+ Sunscreen & Lip balm', 'Altitude-sickness medication (consult doctor)', 'Personal hygiene wipes & sanitizer', 'Water purification tablets'] }
];
