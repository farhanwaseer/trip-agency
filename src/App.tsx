      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full h-[320px] opacity-[0.25] flex items-end">
          <div
            ...
            className="w-[450px] h-full bg-gradient-to-b from-[#111] to-black -ml-20"
          ></div>
          <div
            style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
            className="w-[650px] h-[80%] bg-gradient-to-b from-[#0a0a0a] to-black -ml-40"
          ></div>
          <div
            style={{ clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)" }}
            className="w-[550px] h-[90%] bg-gradient-to-b from-[#0d0d0d] to-black -ml-40"
          ></div>
        </div>
      </div>
